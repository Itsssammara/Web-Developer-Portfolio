    ...
    <nav className="bg-black shadow-md px-6 py-4 fixed top-0 left-0 w-full z-50">
      ...
      >
        ...
        <div className="flex flex-col space-y-6 px-6 pt-6">
          ...
          <a href="#case-studies" onClick={() => setMenuOpen(false)} className="hover:text-purple-400 transition">My Work</a>
          <a href="#about" onClick={() => setMenuOpen(false)} className="hover:text-purple-400 transition">About Me</a>
