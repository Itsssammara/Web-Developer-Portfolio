    ...
    <footer className="bg-[#1f1c2c] text-gray-300 py-10 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6 text-sm">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-gray-400">UI/UX Designer · Cape Town, ZA</p>
        </div>

        <div className="flex gap-6">
          <Link href="#case-studies" className="hover:text-pink-400 transition-colors">Case Studies</Link>
        ...
        <div className="flex gap-4">
          ...
          <a href="https://www.linkedin.com/in/yourprofile" target="_blank" className="hover:text-pink-400 transition-colors">
